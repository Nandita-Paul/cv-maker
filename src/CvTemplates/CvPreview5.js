...
const CvPreview5 = ({ personalInfo, education, template, skills, hobbies, labels }) => {
    return (
        <div>
            <div className="left-cv-layout cvpreview5-wp">
                <div className="lft">
...
export default connect(mapStateToProps)(CvPreview5)
