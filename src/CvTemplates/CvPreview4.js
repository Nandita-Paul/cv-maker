...
const CvPreview4 = ({ personalInfo, education, template, skills, hobbies, labels }) => {
    return (
        <div>
            <div className="left-grey-layout cv-preview-top">

                <div className="inner-wrp">
                    {(personalInfo.name || personalInfo.designation || personalInfo.email || personalInfo.phone || personalInfo.address || personalInfo.alternatephone) && (
                        <div class="top-wrp">
...
export default connect(mapStateToProps)(CvPreview4)
