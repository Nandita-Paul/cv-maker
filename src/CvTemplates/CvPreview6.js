...
const CvPreview6 = ({ personalInfo, education, template, skills, hobbies, labels }) => {
    return (
        <div>
            <div className="left-cv-layout cvpreview5-wp cv-preview6-wp">
                <div className="lft">
                    ...
                    {(personalInfo.email || personalInfo.phone || personalInfo.address || personalInfo.alternatephone || (hobbies && hobbies.length > 0) || (skills && skills.length>0)) && (
                        <div class="lft-btm-wp">
...
export default connect(mapStateToProps)(CvPreview6)
